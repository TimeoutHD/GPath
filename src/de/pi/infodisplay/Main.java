 ...
 * Ohne diese Klasse ist das fertige JAR-Archiv nicht ausführbar.
 * 
 * @author PI A
 *
 */
public class Main {
	 ...
	 * nutzbar zu machen.
	 * 
	 * Eine typische Nutzung für den Start des Servers wäre dies:
			...
			if("server".equalsIgnoreCase(args[0])) {
				try {
					...
					for(int i = 1; i < (args.length -1); i++) {
						// Wenn der Port eine vernünftige Zahlenkombination ist
